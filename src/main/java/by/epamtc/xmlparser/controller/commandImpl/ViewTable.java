...
public class ViewTable implements Command {
    ...
    public void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        boolean isValid = XSDValidator.isValid("../webapps/xmlParser_war/resources/devices.xml", "../webapps/xmlParser_war/resources/devices.xsd");
        //TODO REFACTOR TO SOFT CODE
        if (isValid) {
            try {
                devices = ParserProvider.getInstance().provideParser(parserType).parse("../webapps/xmlParser_war/resources/devices.xml");
